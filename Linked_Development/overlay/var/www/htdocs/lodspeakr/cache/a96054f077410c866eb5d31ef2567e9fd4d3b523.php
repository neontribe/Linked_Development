...
/* Generated from /var/www/htdocs/lodspeakr/components/static/index.html */
function haanga_a96054f077410c866eb5d31ef2567e9fd4d3b523($vars, $return=FALSE, $blocks=array())
{
    extract($vars);
    if ($return == TRUE) {
        ob_start();
 ...
 <div class="navbar navbar-fixed-top">
      <div class="navbar-inner">
        <div class="container">
          ...
          <a class="brand" href="#">'.htmlspecialchars($lodspk['title']).'</a>
